...
int servoPin1 = PA8;                                       // PWM pin connected to servo 1
...
// BUTTONS                                                 
int minButtonPin    = PA5;                                 // button pin to set the minimum LDR value
int maxButtonPin    = PA4;                                 // button pin to set the maximum LDR value
...
// SENSOR                           
int LDRPin = PA2;                                          // the pin connected to the Light Dependent Resistor
// smoothing 1
